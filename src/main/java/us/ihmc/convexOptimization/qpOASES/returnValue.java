...
public enum returnValue {
  TERMINAL_LIST_ELEMENT(qpOASESJNI.TERMINAL_LIST_ELEMENT_get()),
  SUCCESSFUL_RETURN(qpOASESJNI.SUCCESSFUL_RETURN_get()),
  RET_DIV_BY_ZERO,
  ...
  public static returnValue swigToEnum(int swigValue) {
    returnValue[] swigValues = returnValue.class.getEnumConstants();
    if (swigValue < swigValues.length && swigValue >= 0 && swigValues[swigValue].swigValue == swigValue)
      return swigValues[swigValue];
    for (returnValue swigEnum : swigValues)
      if (swigEnum.swigValue == swigValue)
        return swigEnum;
    throw new IllegalArgumentException("No enum " + returnValue.class + " with value " + swigValue);
  }
  ...
  @SuppressWarnings("unused")
  private returnValue(int swigValue) {
    this.swigValue = swigValue;
    SwigNext.next = swigValue+1;
  }

  @SuppressWarnings("unused")
  private returnValue(returnValue swigEnum) {
